...
image = cv2.imread("assignment_01_images/a1q5images/im02small.png", cv2.IMREAD_GRAYSCALE)
...
image = cv.imread("assignment_01_images/a1q5images/im01.png", cv.IMREAD_COLOR) 
if image is None:
