...
img1 = cv.imread("assignment_01_images/rice_gaussian_noise.png", cv.IMREAD_GRAYSCALE)

img2 = cv.imread("assignment_01_images/rice_salt_pepper_noise.png", cv.IMREAD_GRAYSCALE)
